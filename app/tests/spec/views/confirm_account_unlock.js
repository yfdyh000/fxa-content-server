...
function (chai, sinon, p, Session, AuthErrors, Metrics, FxaClient,
  ...
  describe('views/confirm_account_unlock', function () {
    ...
    describe('afterVisible', function () {
      ...
      it('if not caused by signin, sets the ephemeral messages and goes back', function () {
        ephemeralMessages.set('data', {
      ...
      it('redirects to `/account_unlock_complete` if broker does not halt', function () {
        sinon.stub(fxaClient, 'signIn', function () {
          return p({
            sessionToken: 'newSessionToken'
          });
      ...
      it('goes back if the user typed in the wrong password', function () {
        sinon.stub(fxaClient, 'signIn', function () {
      ...
      it('displays any other poll errors', function () {
        sinon.stub(fxaClient, 'signIn', function () {
